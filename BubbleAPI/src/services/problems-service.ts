...
import { inputExempleType, inputProblemType, inputTestCaseType } from "../protocols.js"
...
async function addProblem(problem: inputProblemType, exemples: inputExempleType[], testCases) {
